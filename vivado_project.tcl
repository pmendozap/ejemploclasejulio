...
set files [list \
 [file normalize "${origin_dir}/src/design/binario_bcd_v1.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/design/binario_bcd_v1.sv"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "binario_bcd_v1" -objects $obj
